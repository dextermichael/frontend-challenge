...
// Add one more li element for the empty tile
let container = document.querySelector(".puzzle");
let emptyTile = document.createElement("li");
emptyTile.className = "tile";
container.append(emptyTile);

// select the tiles
let tiles = document.querySelectorAll("li");

function setUp() {
  fillGrid(tiles, letters);
  setId(tiles);

  state.content = getState(tiles);
